        ...
        try:
            ...
            for domain in domains:
                ...
                cmd = "cwas risk_score -i ../06.category/all.sorted.categorization_result.zarr \
                        ...
                        -s ../SAMPLE_LIST.txt \
                        -a ../ADJUST_FACTOR.txt \
                        -c_info ../07.binomial_test_samples/all.sorted.category_info.txt \
                        -thr {0} \
                        -tf {1} \
                        -n_reg 10 \
                        -n 1000 \
                ...
                print("### {0}: Sample-level calculation of Risk-score using control-categories number threshold >= {1}, \
